...
void ExMem::realizarOperacoes()
{
	...
	if ((controle->getBranch() == 0) && (controle->getJump() == 0) && (controle->getmem_wr() == 0) && (controle->getmem_read() == 0))
	...
	else if ((controle->getBranch() == 0) && (controle->getJump() == 0) && ((controle->getmem_wr() == 1) || (controle->getmem_read() == 1)))
